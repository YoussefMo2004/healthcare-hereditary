...
_CLINICAL_STATUS = postgresql.ENUM(
    ...
    name="clinical_status", create_type=True,
)
...
_SEVERITY = postgresql.ENUM(
    ...
    name="condition_severity", create_type=True,
)
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("recorder_id", postgresql.UUID(as_uuid=True),
    ...
    for col in ("patient_id", "encounter_id", "recorder_id",
                "clinical_status", "verification_status", "code", "onset_datetime",
